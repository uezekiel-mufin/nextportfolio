...
const About = () => {
	return (
		<motion.div transiton={{ duration: 2 }} initial={{ opacity: 0 }} animate={{ opacity: 1 }} className='w-full mb-8 pb-8 pt-32 h-full z-[9999] flex justify-center items-center'>
			<main className='flex flex-col-reverse items-center md:grid grid-cols-2 mx-4  gap-8'>
