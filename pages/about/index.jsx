...
const About = () => {
	return (
		<>
			<motion.div transiton={{ duration: 2 }} initial={{ opacity: 0 }} animate={{ opacity: 1 }} className='w-full mb-8 pb-8 pt-32 h-full md:h-[87vh] flex justify-center items-center'>
				<main className='flex flex-col-reverse  md:grid grid-cols-2 mx-4 md:mx-32 gap-8'>
					<section className='flex flex-col px-4 items-center gap-1 justify-start w-full'>
						...
						<button className='w-[80%] lg:w-1/2 mt-8'>
					...
					<section className='flex justify-center'>
						<div className=''>
							<Image src={portfolio} alt='me' layout='intrinsic' height={400} width={400} className=' mx-2  rounded-xl ' />
						</div>
					</section>
				</main>
			</motion.div>
