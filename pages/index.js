		...
		<motion.div className='w-full h-[91vh] flex justify-center items-center'>
			...
			gap-8 justify-center items-center text-center'>
				...
				<div className='flex flex-col md:flex-row mt-20 md:mt-4 gap-4 md:gap-8 justify-center'>
					<Link href='/contact'>
						<motion.a transiton={{ duration: 5000 }} initial={{ x: 1000 }} animate={{ x: 0 }} className='relative animate inline-block px-4 w-[80vw] md:w-[200px] py-3 font-medium group'>
					...
					<Link href='/portfolio'>
						<motion.a transiton={{ duration: 5000 }} initial={{ x: -1000 }} animate={{ x: 0 }} className='relative animate inline-block px-4 py-3 w-[80vw] md:w-[200px] font-medium group'>
							<span className='absolute inset-0 w-full h-full transition duration-200 ease-out transform translate-x-1 translate-y-1 bg-black group-hover:-translate-x-0 group-hover:-translate-y-0'></span>
							<span className='absolute inset-0 w-full h-full bg-white border-2 border-black group-hover:bg-black'></span>
