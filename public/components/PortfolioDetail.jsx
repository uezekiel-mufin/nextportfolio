...
const ProjectDetails = ({ project, setShowProject }) => {
	return (
		<div className='backdrop-brightness-50 overflow-auto  min-h-screen backdrop-blur-lg '>
			<div className='max-w-3xl mx-auto overflow-auto custom-scrollbar h-screen pb-16 bg-white p-4 md:p-8 rounded shadow-lg'>
				<div className='flex justify-end w-full font-bold mb-4 text-red-500'>
					<span onClick={() => setShowProject(false)}>X</span>
				</div>
