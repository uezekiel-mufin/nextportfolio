...
const Contact = () => {
	...
	return (
		<div data-aos='fade-up' data-aos-duration='1000' data-aos-once='true' id='contact' transiton={{ duration: 2 }} initial={{ opacity: 0 }} animate={{ opacity: 1 }} className='flex px-4 gap-8 flex-col w-full'>
