...
const SideNav = ({ closeMenu }) => {
	...
	return (
		<div className='fixed top-0 left-0 right-0 bg-white w-full z-10 flex   md:px-24 pb-4 md:py-7 h-screen'>
			<div className='flex flex-col gap-4 w-full '>
				...
				<section className=' mt-8 flex flex-col gap-4 text-xl px-4'>
					{links.map((link) => (
