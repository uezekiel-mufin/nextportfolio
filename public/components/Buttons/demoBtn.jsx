...
const DemoBtn = ({ liveDemo }) => {
	return (
		<a href={liveDemo} rel='noreferrer' target='_blank' className='relative w-full flex justify-center items-center px-4 py-2 font-medium group'>
			...
			<span className='relative text-black group-hover:text-white'>Live Demo</span>
		</a>
	);
};
