		...
		<>
			{github ? (
				<a href={github} rel='noreferrer' target='_blank' className='relative cursor-pointer w-full flex justify-center md:w-[120px] items-center px-4 py-1 font-medium group'>
					...
					<span className='absolute inset-0 transition duration-400 ease-linear transform   w-full h-full bg-white border-2 border-[#3b5998] group-hover:bg-[#3b5998]'></span>
